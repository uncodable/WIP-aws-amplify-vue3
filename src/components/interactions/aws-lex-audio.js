...
})(
  {
      ...
      function(require, module, exports) {
        (function() {
          ...
          exports.audioControl = function(options) {
             ...
             * @throws {Error} If audio is not supported.
             */
            const exportWAV = function(callback, sampleRate) {
              audioSupported = audioSupported !== false;
              if (!audioSupported) {
                throw new Error(UNSUPPORTED);
              }
             ...
             */
            const playHtmlAudioElement = function(buffer, callback) {
             ...
             * @param {?onPlaybackComplete} callback - Called when audio playback is complete.
             */
            const play = function(buffer, callback) {
              if (typeof buffer === "undefined") {
                return;
              }
              const myBlob = new Blob([buffer]);
             ...
             */
            const supportsAudio = function(callback) {
              callback =
                callback ||
                function() {
                  /* no op */
    ...
    2: [
      function(require, module, exports) {
        (function() {
          "use strict";
          const AudioControl = require("./control.js").audioControl;
          ...
          var applyDefaults = function(config) {
            ...
            const lexConfig = config.lexConfig || {};
      ...
      function(require, module, exports) {
        (function() {
          ...
          const recorder = function(source, silenceDetectionConfig) {
            ...
            const node = source.context.createScriptProcessor(4096, 1, 1);
             ...
             * @param {?visualizerCallback} visualizer - Can be used to visualize the captured buffer.
             */
            const record = function(onSilence, visualizer) {
            ...
            const analyse = function() {
              ...
              const amplitude = silenceDetectionConfig.amplitude;
              const time = silenceDetectionConfig.time;
              ...
              const elapsedTime = newtime - start;
              if (elapsedTime > time) {
                silenceCallback();
              }
            };
          ...
          exports.audioRecorder = function() {
            ...
            const createRecorder = function(silenceDetectionConfig) {
              return recorder(
