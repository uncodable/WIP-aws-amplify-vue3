<template>
  <div
    v-bind:id="SCENE_CONTAINER_DOM_ID"
    v-bind:class="amplifyUI.sumerianSceneContainer"
    v-bind:data-test="sumerianScene.container"
  >
    <div
      v-bind:id="SCENE_DOM_ID"
      v-bind:class="amplifyUI.sumerianScene"
      v-bind:data-test="sumerianScene.sumerianScene"
    >
      <div
        v-if="loading"
        v-bind:class="amplifyUI.loadingOverlay"
        v-bind:data-test="sumerianScene.loading"
      >
        <div v-bind:class="amplifyUI.loadingContainer">
          <div
            v-bind:class="amplifyUI.loadingLogo"
            v-bind:data-test="sumerianScene.loadingLogo"
          >
            <svg
              version="1.1"
              id="Layer_1"
              ...
              x="0px"
              y="0px"
              viewBox="0 0 2000 1195"
              style="enable-background:new 0 0 2000 1195;"
              xml:space="preserve"
            >
              <g>
                <path
                  class="st0"
                  d="M1026.8,146.2c-0.7,2.3-1.2,3.7-1.6,5.1C991.8,291,958.5,430.6,925,570.3c-1.6,6.7-3.8,13.3-6.2,19.7
                ...
                <path
                  class="st0"
                  d="M995.7,1194.2c-23.1,0-46.2,0.8-69.3-0.2c-25.4-1.1-50.7-3.5-76-5.7c-77.9-7-154.6-20.9-230.3-40.5
                ...
                <path
                  class="st0"
                  d="M1714.8,0c39.2,0.9,85.7,8.5,130.2,26.1c9.3,3.7,17.9,9.3,26.1,15.1c9,6.4,13.3,15.9,13.4,27.1
                ...
                <path
                  class="st0"
                  d="M1860.6,746.5c33.3,0.4,66.3,2.8,98.5,11.6c8.4,2.3,16.5,5.8,24.6,9.1c7.5,3.1,11.9,9.2,13.5,17.2
                ...
                <path
                  class="st0"
                  d="M591.6,541.4c-21.4-36.5-29.7-76.2-29.7-117.9c-0.1-70.3,0.1-140.6-0.1-211c-0.1-29.6-3.8-58.8-13-87.1
          ...
          <div
            v-bind:class="amplifyUI.loadingSceneName"
            v-bind:data-test="sumerianScene.sceneName"
          >
            {{ sceneName }}
          </div>
          <div
            v-if="sceneError"
            v-bind:class="amplifyUI.sceneErrorText"
            v-bind:data-test="sumerianScene.sceneError"
          >
            {{ sceneError }}
          </div>
          <div
            v-if="!sceneError"
            v-bind:class="amplifyUI.loadingBar"
            v-bind:data-test="sumerianScene.loadingBar"
          >
            <div
              v-bind:class="amplifyUI.loadingBarFill"
              v-bind:style="{ width: loadPercentage + '%' }"
            ></div>
          </div>
        </div>
      </div>
    ...
    <div
      v-if="!loading"
      v-bind:class="amplifyUI.sceneBar"
      v-bind:data-test="sumerianScene.bar"
    >
      <span
        v-bind:class="amplifyUI.sceneActions"
        v-bind:data-test="sumerianScene.actions"
      >
        <div
          v-bind:class="[
            amplifyUI.tooltip,
            showEnableAudio ? amplifyUI.autoShowTooltip : ''
          ]"
          :data-text="
            showEnableAudio
              ? 'The scene is muted. Click to unmute.'
              : muted
              ? 'Unmute'
              : 'Mute'
          "
          v-on:click="muted ? setMuted(false) : setMuted(true)"
        >
        ...
        <div
          v-if="isVRCapable && !isVRPresentationActive"
          v-bind:class="amplifyUI.tooltip"
          data-text="Enter VR"
          v-on:click="toggleVRPresentation()"
        >
          <button v-bind:class="amplifyUI.actionButton">
            <svg
              width="19"
